...
* Замерьте время синхронной проверки ссылок.
 ![image](https://user-images.githubusercontent.com/77889009/144434409-611ae0de-5764-4508-a145-1942779795ce.png)
![image](https://user-images.githubusercontent.com/77889009/144434469-4963db99-184d-46f6-9b38-eaf74700d6c6.png)

* Перепишите код, используя `ThreadPoolExecutor`. 
* Изменяйте количество воркеров: 5, 10, 100.
5 воркеров
![image](https://user-images.githubusercontent.com/77889009/144434670-23a0ff0b-3830-468a-af21-2e0c659cd030.png)
На 5-ти воркерах время выполнения уменьшилось примерно в 5 раз, но увеличилась нагрузка на ЦП и память
![image](https://user-images.githubusercontent.com/77889009/144434707-2e22be69-8e71-4181-9f3b-47ae87fbe579.png)

10 воркеров
![image](https://user-images.githubusercontent.com/77889009/144435118-af11c41c-4f1b-4340-bbe5-c307445e49d5.png)

100 воркеров
![image](https://user-images.githubusercontent.com/77889009/144435193-9ed60381-e5aa-4a6c-bb15-b4095f6f5bd0.png)
![image](https://user-images.githubusercontent.com/77889009/144435224-98712d79-2cf1-45a7-b627-2f75c804c6d1.png)
...
* Во время работы посмотрите с использованием стандартных утилит вашей OC загрузку памяти, процессора, сети, время работы. Зависят ли они от количества воркеров и как?
  -----Да, зависит. С увеличением воркеров уменьшается время выполнения программы, но растет нагрузка.
...
![image](https://user-images.githubusercontent.com/77889009/144441525-3393b9b9-d238-48fe-ac12-105d813608e5.png)
